    ...
    return(
        <div id ="body" className="bg-[url('/Background/Duels.jpg')] w-screen h-screen bg-no-repeat bg-center bg-cover bg-fixed flex items-center">
            <div id = "player-actions" className="flex flex-col px-6">
                ...
                <div id = "choose-characters-here" className=" ring-black/10 ring-1 bg-white/10 backdrop-blur-sm shadow-2xl px-3 py-6 halo min-w-170 w-fit min-h-50 h-fit flex flex-col gap-2 items-center border-2 border-zinc-400/10 rounded-2xl"></div>
            </div>
            ...
            <div id = "bot-actions-and-difficulty" className="flex flex-col gap-2">
                ...
                <div id = "difficulties" className="w-165 h-fit gap-3 flex justify-evenly">
                    <button className="flex-1 mx-5 rounded-lg hover: cursor-pointer py-3 px-10 text-center bg-green-500 hover:bg-green-600 hover:scale-105 transition-all h-fit w-fit">EASY</button>
                    <button className="flex-1 mx-5 rounded-lg hover: cursor-pointer py-3 px-6 bg-orange-400 hover:brightness-90 hover:scale-105 transition-all h-fit w-fit">MEDIUM</button>
                    <button className="flex-1 mx-5 rounded-lg hover: cursor-pointer py-3 px-6 bg-red-400 hover:brightness-90 hover:scale-105 transition-all h-fit w-fit">HARD</button>
                    <button className="flex-1 mx-5 rounded-lg hover: cursor-pointer py-3 px-6 bg-purple-500 hover:brightness-90 hover:scale-105 transition-all h-fit w-fit">IMPOSSIBLE</button>
                </div>
            </div>
